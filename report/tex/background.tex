...
The chosen methods, are possible to implement for mixed data, but are available online as numerical methods. From a thesis standpoint, tackling the high-dimensionality of a dataset was the main priority. As such, only numerical features of the dataset can be used --- See Dataset in Chapter 3. For more details. % The prestudy has
% The following 
