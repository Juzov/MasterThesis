...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{.7\textwidth}
  \centering
  \includegraphics[width=.99\textwidth]{../../repos/fsc/clusters/500-plots-mannen-1/K_500_L_1-5/plots/heatmap.png}
  \caption{$\gamma=1.5$}
  \end{subfigure}
  \begin{subfigure}[b]{.7\textwidth}
  \centering
  \includegraphics[width=.99\textwidth]{../../repos/fsc/clusters/500-plots-mannen-1/K_500_L_2-1/plots/heatmap.png}
  \caption{$\gamma=2.1$}
  \end{subfigure}
  }\\
  \makebox[\linewidth][c]{
  \begin{subfigure}[b]{.7\textwidth}
  \centering
  \includegraphics[width=.99\textwidth]{../../repos/fsc/clusters/500-plots-mannen-1/K_500_L_3-0/plots/heatmap.png}
  \caption{$\gamma=3.0$}
  \end{subfigure}
  \begin{subfigure}[b]{.7\textwidth}
  \centering
  \includegraphics[width=.99\textwidth]{../../repos/fsc/clusters/500-plots-mannen-1/K_500_L_5-0/plots/heatmap.png}
  \caption{$\gamma=5.0$}
  \end{subfigure}
  }
  \caption{Feature-weight meshgrid of FSC ($k=500$)}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{.7\textwidth}
  \centering
  \includegraphics[width=.99\textwidth]{../../repos/fsc/clusters/500-plots-mannen-1/K_500_L_1-5/plots/weights.png}
  \caption{$\gamma=1.5$}
  \end{subfigure}
  \begin{subfigure}[b]{.7\textwidth}
  \centering
