...
def get_numerical_data(data, only_embedding):
    ...
    # numerical_data = pd.DataFrame(minmax_scale(numerical_data))
    # numerical_data =  pd.DataFrame(minmax_scale(numerical_data), columns=list(numerical_data))
    # numerical_data.values = a
    # numerical_data = numerical_data.apply(min_max_scaling, axis=0)
